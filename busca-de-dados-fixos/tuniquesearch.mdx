...
Derivado da classe `TMultiSearch`, métodos herdados não sobrescritos podem também ser utililzados por objetos `TUniqueSearch`. Acesse a [documentação do componente/classe-pai](busca-de-dados-fixos/tmultisearch) para conhecê-los.
