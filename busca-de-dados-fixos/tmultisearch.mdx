...
Derivado da classe `TSelect`, métodos herdados não sobrescritos podem também ser utililzados por objetos `TMultiSearch`. Acesse a [documentação do componente/classe-pai](selecao-de-dados-fixos/tselect) para conhecê-los.
