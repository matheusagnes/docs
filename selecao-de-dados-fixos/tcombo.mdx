...
**Parâmetros:**
<ResponseField name="$option" type="mixed" required>Valor da opção padrão.</ResponseField>
...
<ResponseField name="$startEmpty" type="bool" default="FALSE">(Opcional) Se o combo começará vazio.</ResponseField>
<ResponseField name="$fire_events" type="bool" default="TRUE">(Opcional) Se a ação de mudança será disparada.</ResponseField>
