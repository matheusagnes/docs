...
import DerivationDescription from '/snippets/derivation-description.mdx';

<DerivationDescription extendedClass="TEntry" class="TBarCodeInputReader" folder="entrada-de-dados" file="tentry" />
