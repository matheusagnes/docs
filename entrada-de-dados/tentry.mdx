...
<AccordionGroup>
  <Accordion title="Parâmetros">
    <RequiredParameter parameter="$decimals" type="mixed" description="" />
    <RequiredParameter parameter="$decimalsSeparator" type="mixed" description="" />
    <RequiredParameter parameter="$thousandSeparator" type="mixed" description="" />
    <OptionalParameter parameter="$replaceOnPost" type="bool" defaultValue="false" description="(opcional) Booleano indicando se a máscara deve ser substituída após o envio do formulário." />
