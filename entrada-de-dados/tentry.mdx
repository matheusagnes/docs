...
<AccordionGroup>
  <Accordion title="Parâmetros">
    <RequiredParameter parameter="$options" type="array" description="Array de opções para conclusão." />
  </Accordion>
  <Accordion title="Exemplo de código">
    ```php
...
<AccordionGroup>
  <Accordion title="Parâmetros">
    <RequiredParameter parameter="$length" type="mixed" description="Comprimento máximo do campo." />
  </Accordion>
  <Accordion title="Exemplo de código">
    ```php
    $rg = new TEntry('rg');
