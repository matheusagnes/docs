...
import DefaultParameter from '/snippets/default-parameter.mdx';
...
<AccordionGroup>
  <Accordion title="Parâmetros">
    <RequiredParameter parameter="$name" type="string" description="Nome do campo que será utilizado no formulário." />
  </Accordion>
...
<AccordionGroup>
  <Accordion title="Parâmetros">
    <RequiredParameter parameter="$value" type="string" description="Uma string contendo o valor do campo." />
  </Accordion>
  <Accordion title="Exemplo de código">
    ```php
    $cnpj = new TEntry('cnpj');
...
<AccordionGroup>
  <Accordion title="Parâmetros">
    <RequiredParameter parameter="$mask" type="string" description="Máscara para os dados de entrada." />
    <DefaultParameter parameter="$replaceOnPost" type="bool" defaultValue="false" description="(opcional) Booleano indicando se a máscara deve ser substituída após o envio do formulário." />
  </Accordion>
  <Accordion title="Exemplo de código">
    ```php
    $cpf = new TEntry('cpf');
