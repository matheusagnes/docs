...
<AccordionGroup>
  <Accordion title="Parâmetros">
    ...
    <DefaultParameter parameter="$replaceOnPost" type="bool" default="false" description="(opcional) Booleano indicando se a máscara deve ser substituída após o envio do formulário." />
  </Accordion>
  <Accordion title="Exemplo de código">
    ```php
    $cpf = new TEntry('cpf');
