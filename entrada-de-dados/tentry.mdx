...
<AccordionGroup>
  <Accordion title="Parâmetros">
    ...
    <DefautParameter parameter="$replaceOnPost" type="bool" default="false" description="(opcional) Booleano indicando se a máscara deve ser substituída após o envio do formulário." />
  </Accordion>
  <Accordion title="Exemplo de código">
    ```php
    $cpf = new TEntry('cpf');
