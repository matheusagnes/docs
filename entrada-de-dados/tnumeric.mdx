...
Derivado da classe `TEntry`, métodos herdados não sobrescritos podem também ser utililzados por objetos `TNumeric`. Acesse a [documentação do componente/classe-pai](entrada-de-dados/tentry) para conhecê-los.
